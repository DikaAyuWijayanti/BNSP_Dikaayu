            ...
            <div id="page-inner">
                <div class="row">
                    ...
                    <div class="box">
                        ...
                        <?php
                            $id = $_GET['id'];
                            $data = mysqli_query($db, "SELECT * FROM tb_anggota WHERE id = $id");
                            $row = mysqli_fetch_array($data);
                        ?>
                        Nomor : <?php echo $row['nomor_surat']; ?>;<br>
                        Kategori : <?php echo $row['kategori']; ?><br>
                        Judul : <?php echo $row['judul']; ?><br>
                        Waktu Unggah : <?php echo $row['waktu_pengarsipan']; ?>
                        <br><br>
                        ...
                        <a href="download.php?file=<?= $row['file']; ?>"><button class="btn btn-primary">Unduh</button></a>
