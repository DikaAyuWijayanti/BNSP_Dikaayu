                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Apakah Anda yakin ingin menghapus arsip surat ini?')" href="?page=buku&aksi=hapus&id=<?php echo $data['nomor_surat']; ?>" class="btn btn-danger" ><i class="fa fa-trash"></i> Hapus</a>
...
<a href="tambah.php" class="btn btn-success" style="margin-top: 8px;"><i class="fa fa-plus"></i> Arsipkan Surat</a>
                                    </table>
